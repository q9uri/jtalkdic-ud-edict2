...
with bz2.open("./mozcdic-ut-edict2.txt.bz2", "rt", encoding="utf-8") as f:
    data = f.read()
...
Path("./build/jtalkdic-ud-edict2-ipadic.csv").write_text("\n".join(out), encoding="utf-8")
...
Path("./build/jtalkdic-ud-edict2-noacc.csv").write_text("\n".join(out), encoding="utf-8")